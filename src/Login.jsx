...
export default class  extends Component {
  render() {
    return (
      <div className=''>
      <div class="flex justify-center min-h-screen pr">  
  <div class="container sm:mt-40 mt-24 my-auto max-w-md border-2 border-gray-200 p-3 bg-gray-300 ">
    {/* <!-- header -->   */}
    ...
    <div class="m-6">
      <form class="mb-4">
        ...
        <p class="text-sm text-center text-gray-400">
          ...
          <Link to="/Signup">
          <h4  class="font-semibold text-indigo-500 focus:text-indigo-600 focus:outline-none focus:underline">Sign up</h4>.
          </Link>
