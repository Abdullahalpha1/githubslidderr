...
<div class="max-w-2xl mx-auto py-44 ">

<form>
  <div class="relative z-0 mb-6 w-full group">
    <input type="email" name="floating_email" class="block py-2.5 px-0 w-full text-sm text-white bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
  ...
  <Link to="/">
  <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Sign up</button>
  </Link>
  
</form>

<p class="mt-5">Check out the original floating label form elements on <a class="text-blue-600 hover:underline"
    href="#" target="_blank">Our Site</a> and browse other similar components built with Tailwind CSS.
</p>
</div>
